...
// Generated on: 2024-05-02 15:10:17
// -------------------------------------------------------------
...
// FIRAdderStyle: tree
// OptimizeForHDL: on
// TargetDirectory: D:\fax\zavrsni\invSincSpec
// AddPipelineRegisters: on
// Name: invSincSpec
// TargetLanguage: Verilog
// TestBenchName: invSincSpec_tb
...
////////////////////////////////////////////////////////////////
//Module Architecture: invSincSpec
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  parameter signed [15:0] coeffphase1_1 = 16'b0000000011111010; //sfix16_En14
  parameter signed [15:0] coeffphase1_2 = 16'b1111100011000011; //sfix16_En14
  parameter signed [15:0] coeffphase1_3 = 16'b0010011001000011; //sfix16_En14
  parameter signed [15:0] coeffphase1_4 = 16'b0010011001000011; //sfix16_En14
  parameter signed [15:0] coeffphase1_5 = 16'b1111100011000011; //sfix16_En14
  parameter signed [15:0] coeffphase1_6 = 16'b0000000011111010; //sfix16_En14
  parameter signed [15:0] coeffphase2_1 = 16'b0000000000011100; //sfix16_En14
  parameter signed [15:0] coeffphase2_2 = 16'b1111111011101011; //sfix16_En14
  parameter signed [15:0] coeffphase2_3 = 16'b0100000111110001; //sfix16_En14
  parameter signed [15:0] coeffphase2_4 = 16'b1111111011101011; //sfix16_En14
  parameter signed [15:0] coeffphase2_5 = 16'b0000000000011100; //sfix16_En14
  parameter signed [15:0] coeffphase2_6 = 16'b0000000000000000; //sfix16_En14

  // Signals
  reg  [1:0] cur_count; // ufix2
  wire phase_1; // boolean
  reg  signed [19:0] delay_pipeline [0:5] ; // sfix20_En15
  wire signed [35:0] product; // sfix36_En29
  wire signed [15:0] product_mux; // sfix16_En14
  wire signed [35:0] product_1; // sfix36_En29
  wire signed [15:0] product_mux_1; // sfix16_En14
  wire signed [35:0] product_2; // sfix36_En29
  wire signed [15:0] product_mux_2; // sfix16_En14
  wire signed [35:0] product_3; // sfix36_En29
  wire signed [15:0] product_mux_3; // sfix16_En14
  wire signed [35:0] product_4; // sfix36_En29
  wire signed [15:0] product_mux_4; // sfix16_En14
  wire signed [35:0] product_5; // sfix36_En29
  wire signed [15:0] product_mux_5; // sfix16_En14
  wire signed [38:0] sumvector1 [0:2] ; // sfix39_En29
  wire signed [35:0] add_signext; // sfix36_En29
  wire signed [35:0] add_signext_1; // sfix36_En29
  wire signed [36:0] add_temp; // sfix37_En29
  ...
  wire signed [35:0] add_signext_4; // sfix36_En29
  wire signed [35:0] add_signext_5; // sfix36_En29
  wire signed [36:0] add_temp_2; // sfix37_En29
  reg  signed [38:0] sumdelay_pipeline1 [0:2] ; // sfix39_En29
  wire signed [38:0] sumvector2 [0:1] ; // sfix39_En29
  wire signed [38:0] add_signext_6; // sfix39_En29
  wire signed [38:0] add_signext_7; // sfix39_En29
  wire signed [39:0] add_temp_3; // sfix40_En29
  reg  signed [38:0] sumdelay_pipeline2 [0:1] ; // sfix39_En29
  wire signed [38:0] sum3; // sfix39_En29
  wire signed [38:0] add_signext_8; // sfix39_En29
  wire signed [38:0] add_signext_9; // sfix39_En29
  wire signed [39:0] add_temp_4; // sfix40_En29
  ...
  assign output_typeconvert = ((sum3[38] == 1'b0 & sum3[37:31] != 7'b0000000) || (sum3[38] == 1'b0 && sum3[31:14] == 18'b011111111111111111) // special case0
) ? 18'b011111111111111111 : 
      (sum3[38] == 1'b1 && sum3[37:31] != 7'b1111111) ? 18'b100000000000000000 : (sum3[31:0] + {sum3[14], {13{~sum3[14]}}})>>>14;
